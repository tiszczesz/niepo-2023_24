...
<body>
    ...
    <div class="container">
        ...
        <form method="post" class="mt-5">
            ...
            <div class="row m-2">
                <label for="salary" class="col-3">Podaj pensję</label>
                <input class="col-6" type="number" min="2000" name="salary" id="salary" required />
            </div>
            <div class="row m-2">
                <label for="manager" class="col-3">Podaj stanowisko</label>
                <select class="col-6" name="manager" id="manager">
                    <?php
